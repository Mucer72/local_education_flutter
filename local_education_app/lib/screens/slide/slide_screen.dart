...
class SlideScreen extends StatefulWidget {
  const SlideScreen({super.key, required this.lessonId});
...
class _SlideScreenState extends State<SlideScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              backgroundColor: const Color.fromARGB(255, 13, 33, 8), // Set the background color here
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 13, 33, 8), 
        leading: IconButton(
          onPressed: () {
            SystemChrome.setPreferredOrientations(
              [
                              ...
                              return Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 8), // Khoảng cách giữa hình ảnh và nội dung
                                    Image(
                                      image: NetworkImage(
                                        "$domain/${currentSlide.urlPath}",
                                      ),
